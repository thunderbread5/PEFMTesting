 ...
 * @author nickg
 */
public class PractitionerDashboardAvgWrapper {
    private Long programmeId;
    private String programmeName;
    private Double progAvgCompetency;
    private Double progAvgAdherence;

    public PractitionerDashboardAvgWrapper() {
    }

    public PractitionerDashboardAvgWrapper(Long programmeId, String programmeName, Double progAvgCompetency, Double progAvgAdherence) {
